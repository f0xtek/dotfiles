# Generated by Powerlevel10k configuration wizard on 2025-01-10 at 14:07 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|cdk|terraform|pulumi|terragrunt|cloudfox|aws-enumerator|s3-account-search'
